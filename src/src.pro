...
blackberry*:SRC_SUBDIRS += src_bbsupport
...
blackberry*: {
   src_bbsupport.subdir = $$QT_SOURCE_TREE/src/bbsupport
   src_bbsupport.target = sub-bbsupport
   src_bbsupport.depends = src_corelib
   src_plugins.depends += src_bbsupport
}

...
#ifndef QBBWINDOWSURFACE_H
#define QBBWINDOWSURFACE_H
...
class QBBWindowSurface : public QWindowSurface
{
public:
    QBBWindowSurface(QWidget *window);
    virtual ~QBBWindowSurface();

      ...
      mPosted(false)
{
    ...
    if (result != 0) {
        qFatal("QBB: failed to create bufferless window, errno=%d", errno);
    }
    ...
    if (result != 0) {
        qFatal("QBB: failed to set window transparency, errno=%d", errno);
    }
    ...
    if (result != 0) {
        qFatal("QBB: failed to set window swap interval, errno=%d", errno);
    }
